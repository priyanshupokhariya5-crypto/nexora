  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 font-sans selection:bg-brand-600 selection:text-white overflow-x-hidden">
      ...
      <section className="relative overflow-hidden pt-20 pb-24 md:pt-32 md:pb-40 border-b border-slate-200/80 bg-grid-light">
        ...
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[500px] bg-gradient-to-tr from-brand-100/50 via-indigo-100/40 to-amber-100/40 rounded-full blur-3xl -z-10 pointer-events-none" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <div className="rounded-3xl border border-slate-300/80 bg-white/90 backdrop-blur-xl shadow-2xl p-3 sm:p-4 relative">
              ...
              {/* Browser Header Bar */}
              <div className="flex items-center justify-between px-4 py-3 bg-slate-100/90 rounded-2xl mb-3 border border-slate-200/80">
                <div className="flex items-center space-x-2">
                  <div className="w-3 h-3 rounded-full bg-red-400" />
                  <div className="w-3 h-3 rounded-full bg-amber-400" />
                  <div className="w-3 h-3 rounded-full bg-emerald-400" />
                </div>
                <div className="px-4 py-1.5 rounded-xl bg-white text-xs font-mono text-slate-600 border border-slate-300/80 flex items-center space-x-2 shadow-soft-sm">
                  <Globe className="w-3.5 h-3.5 text-brand-600" />
                  <span>https://nexora.app/editor/live-preview</span>
                </div>
                <div className="flex items-center space-x-2 text-xs font-semibold">
                  <span className="px-3 py-1 rounded-full bg-emerald-50 text-emerald-700 border border-emerald-200/80 flex items-center space-x-1.5">
      ...
      <section className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="rounded-3xl bg-slate-900 text-white p-10 sm:p-16 text-center relative overflow-hidden shadow-2xl border border-slate-800">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[300px] bg-gradient-to-r from-brand-600/30 to-amber-500/20 blur-3xl pointer-events-none" />
